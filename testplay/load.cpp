...
void CLOAD::Data_Load()
{
	...
	//プレイヤーの情報をファイルから読み込む
	{
		...
		std::string playerpass = "asset/testsavedata/playerdata.json";	//jsonファイル名
	...
	//敵の情報をファイルから読み込む
	{
		...
		std::string enemypass = "asset/testsavedata/enemydata.json";	//jsonファイル名
	...
	//味方情報をファイルから読み込む
	{
		...
		std::string enemypass = "asset/testsavedata/frienddata.json";	//jsonファイル名
	...
	//バンカー情報をファイルから読み込む
	{
		...
		std::string bunkerpass = "asset/testsavedata/bunkerdata.json";	//jsonファイル名
	...
	//拠点情報をファイルから読み込む
	{
		...
		std::string basepass = "asset/testsavedata/basedata.json";	//jsonファイル名
	...
	//木情報をファイルから読み込む
	{
		...
		std::string treepass = "asset/testsavedata/treedata.json";	//jsonファイル名
	...
	//枯れ木情報をファイルから読み込む
	{
		...
		std::string deadtreepass = "asset/testsavedata/deadtreedata.json";	//jsonファイル名
	...
	//スポーンポイント情報をファイルから読み込む
	{
		...
		std::string spownpointpass = "asset/testsavedata/spownpointdata.json";	//jsonファイル名
	...
	//地形情報をファイルから読み込む
	{
		...
		std::string fieldpass = "asset/testsavedata/field.json";	//jsonファイル名
